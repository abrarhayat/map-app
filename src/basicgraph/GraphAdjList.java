...
public class GraphAdjList extends Graph {
	...
	public List<Integer> getInNeighbors(int v) {
		...
		for (int currentVertex : adjListsMap.keySet()) {
			...
			for (int currentVertexNeighbor : adjListsMap.get(currentVertex)) {
				if (v == currentVertexNeighbor) {
					inNeighbors.add(currentVertex);
				}
			}
		}
		return inNeighbors;
	 ...
	 */		
	 public List<Integer> getDistance2(int v) {
		 ...
		 List<Integer> d2Neighbors = new ArrayList<>();
		 for(int currentNeighbor : neighbors) {
		 	List<Integer> currentD2Neighbors = getNeighbors(currentNeighbor);
			 d2Neighbors.addAll(currentD2Neighbors);
		 }
		 return d2Neighbors;
	}
